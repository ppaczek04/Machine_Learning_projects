...
Original file is located at
    https://colab.research.google.com/drive/1VQuSzK2pW9a7UVnqdArOw5gQGICDtC0-
...
bag_clf = BaggingClassifier(
    ...
    bootstrap_features=False,  # decisive-features cannot chosen with repetition (decisive-features cannot be chosen twice for the same tree)
)
bag_clf.fit(X_train, y_train)
