...
Original file is located at
    https://colab.research.google.com/drive/1-Mnf8YtsJSrz_7lt612VfmRnsLFEZc1o
...
bag_clf = BaggingClassifier(
    ...
    n_estimators=30,
    max_samples=0.5,      # połowa próbek dla kazdego drzewa
    bootstrap=True,       # probki wybierane z powtorzeniami
    max_features=2,       # 2 cechy dla drzewa
    bootstrap_features=False,  # cechy wybierane bez powtórzeń (domyślnie tak)
)
bag_clf.fit(X_train, y_train)  # Uwaga! Tu użyj pełnego X_train z wszystkimi cechami!
...
# Lista nazw wszystkich cech
feature_names = X.columns

# Tworzymy ranking
ranking = []

for est, feat_idxs in zip(bag_clf.estimators_, bag_clf.estimators_features_):
...
# Tworzymy i sortujemy DataFrame
import pandas as pd
