...
Original file is located at
    https://colab.research.google.com/drive/1MeEVenoeWnCJwVt_TLxaTAl_7lLHYHsL
...
"""**We created a model that classifies cancer cases as either Malignant or Benign with the accuracy of 90% thanks to the usage of LinearSVC model**
...
"""**As you can see, SVM models which try to find best division value can be used to perform linear-regression. These models use different hyperparameters which can be manipulated in order to achieve better results with our data**"""
